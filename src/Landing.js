  ...
  return (
    <div className="flex justify-between items-center">
      ...
      <div className="flex-col text-center ml-2 w-2/5">
        ...
        <p className="text-slate-300 mt-12">
          Train with most suitable partners according to your level and
          preferences. Challenge others and make your way to the top.
        </p>
